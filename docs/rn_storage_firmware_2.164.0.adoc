...
---
= Note sulla versione di Storage firmware Bundle 2.164.0
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
La versione 2.164.0 del bundle firmware di storage contiene il supporto per NIC, Mellanox CX5 16.32.1010 e un aggiornamento del firmware per l'unità PM9A3.
