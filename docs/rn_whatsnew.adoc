...
NOTE: Element Software 12.9 è l'ultima versione e include aggiornamenti dei componenti di sistema e di sicurezza, miglioramenti operativi e problemi risolti. https://docs.netapp.com/us-en/element-software/concepts/concept_rn_whats_new_element.html["Scopri di più sulle novità di Element 12.9"^] .
