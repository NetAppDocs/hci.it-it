...
Se si esegue un aggiornamento sul posto di un Witness Node esistente a Element 12.8 o versione successiva, prima di eseguire l'aggiornamento è necessario assicurarsi che la versione hardware della VM sul Witness Node sia compatibile con ESXi 6.7 (versione hardware della VM 14) o versione successiva, a seconda dell'ambiente. Vederelink:task_hcc_upgrade_management_node.html#upgrade-vm-hardware["Aggiornare la versione hardware della VM"] .
