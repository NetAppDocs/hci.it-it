...
* link:rn_compute_firmware_2.179.0.html["Note sulla versione di Compute firmware Bundle 2.179.0"]
...
* link:rn_storage_firmware_2.182.0.html["Note di rilascio del bundle del firmware di archiviazione 2.182.0"]
