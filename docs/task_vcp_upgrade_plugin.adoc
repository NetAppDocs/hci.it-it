...
** La pagina di registrazione del plug-in vCenter per il plug-in Element per vCenter Server 4.x:
+
...
+
image::vcp_remote_plugin_icons_home_page.png[Mostra il punto di estensione del plug-in dopo un aggiornamento o un'installazione riusciti per Element Plug-in 5.10 o versioni successive]
